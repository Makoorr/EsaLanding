export function Immatriculation() {
    return (
        <div className="relative py-10 my-10 px-60">
            ...
            <div className="grid grid-cols-4 border-[6px] border-orange-500 rounded-3xl shadow-2xl">
                <div className="-translate-y-4 -translate-x-14 scale-150 w-96 h-96 rounded-full border-[16px] border-orange-500 bg-white">
                    <img
                ...
                <div className="col-span-3 pl-20 py-4 mb-4 w-full">
                    <h1 className="pl-2 text-[45px] leading-[3rem] font-semibold mb-8">
                        (H2) La certification, <span className="text-orange-500">Plateforme de Dématérialisation Partenaire (PDP)</span>
                    </h1>

                    <div className="flex gap-4">
                        <span className="pl-10 text-lg text-gray-500 text-justify leading-5">    
